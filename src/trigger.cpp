    ...
    for (size_t i = 0; i < portCount; i++) {
      ...
      for (size_t iNode = 0; iNode < myPort.NodeCount(); iNode++) {
        ...
        /*if (theNode.Motion.Homing.HomingValid())
        {
                ...
                {
                        printf("Node %d has already been homed, current position
        is: \t%8.0f \n", iNode, theNode.Motion.PosnMeasured.Value());
                        printf("Rehoming Node... \n");
                }
                else
                {
                        printf("Node [%d] has not been homed.  Homing Node
        now...\n", iNode);
                }
      ...
      buffer = theNode.Motion.Adv.MovePosnStart(500000, true, true, false);
      printf("buffer:%i\n", buffer);
      buffer = theNode.Motion.Adv.MovePosnStart(50000, true, true, false);
      printf("buffer:%i\n", buffer);
      ...
      theNode.Motion.Adv.TriggerMove();
      printf("running\n");
